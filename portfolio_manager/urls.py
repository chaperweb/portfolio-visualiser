...
urlpatterns = [
    ...
    url(r'^presentations(/(?P<presentation_id>[0-9]+))?$', views.presentation, name="presentations"),
        ...
        url(r'^presentations/remove_presentation_snapshot((/(?P<presentation_id>[0-9]+))?(/(?P<snapshot_type>[A-Za-z]+))?(/(?P<snapshot_id>[0-9]+))?)?$', views.remove_presentation_snapshot, name='remove_presentation_snapshot'),
